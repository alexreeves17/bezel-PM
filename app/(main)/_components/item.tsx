...
export const Item = ({
    ...
    const onArchive = (
        ...
        toast.promise(promise, {
            loading:"Archiving doc(s)",
            success: "Doc(s) archived",
            error: "Failed to archive doc(s)"
        });
    }
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger
                            ...
                            >
                                <div
                                    role="button"
                                    className="opacity-0 group-hover:opacity-100 h-fell ml-auto rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600"
                                >
